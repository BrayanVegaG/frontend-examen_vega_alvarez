...
import { apiService, Donante, Beneficiario, Donacion } from '../services/apiService';
...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const donantesData = await apiService.getDonantes();
      const beneficiariosData = await apiService.getBeneficiarios();
      const donacionesData = await apiService.getDonaciones();
